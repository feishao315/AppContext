...
//    static String apkPath = androidDemoPath + File.separator + "/st_demo.apk";
	...
	static String apkPath = "./sampleApk/09b143b430e836c513279c0209b7229a4d29a18c.apk";
...
//			}
        ...
        //save context information to csv file
        String csv = "out.csv";
		try {
			CSVWriter writer = new CSVWriter(new FileWriter(csv, true));//, true
		
			List<String[]> data = new ArrayList<String[]>();
			for(PermissionInvocation permInvoc: perInvocs){
				String permission = permInvoc.getPermission();
				String tgt = permInvoc.getTgt().toString();
				ArrayList<String> result = new ArrayList<String>();
				result.add(AndroidUtil.getPackageName(apkPath));
